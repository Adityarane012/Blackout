        ...
        <div className="relative z-10 px-16 xl:px-24 max-w-3xl">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground font-light leading-relaxed mb-8">
              Create an account to save architectures, replay simulations, and track your system's resilience over time. Unlock the full capabilities of the neural uplink.
            </p>
