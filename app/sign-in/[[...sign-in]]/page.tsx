    ...
    <div className="relative min-h-screen bg-background text-foreground flex overflow-hidden">
      ...
      <div className="relative hidden w-0 flex-1 lg:block bg-secondary/10 border-l border-border/50 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 z-10">
          ...
          >
            <div className="absolute top-1/2 left-1/4 w-3 h-3 bg-cyan-500 rounded-full shadow-[0_0_15px_rgba(34,211,238,0.5)] animate-pulse" />
            <div className="absolute top-1/3 left-1/2 w-3 h-3 bg-purple-500 rounded-full shadow-[0_0_15px_rgba(168,85,247,0.5)] animate-pulse" style={{ animationDelay: "0.5s" }} />
            <div className="absolute top-2/3 right-1/4 w-3 h-3 bg-zinc-500 rounded-full shadow-[0_0_15px_rgba(113,113,122,0.5)] animate-pulse" style={{ animationDelay: "1s" }} />
            
            <svg className="absolute inset-0 w-full h-full">
              <line x1="25%" y1="50%" x2="50%" y2="33%" stroke="#3f3f46" strokeWidth="2" strokeDasharray="4,4" className="animate-[dash_20s_linear_infinite]" />
              <line x1="50%" y1="33%" x2="75%" y2="66%" stroke="#3f3f46" strokeWidth="2" strokeDasharray="4,4" className="animate-[dash_20s_linear_infinite]" />
            </svg>
          </motion.div>
        </div>
      </div>
